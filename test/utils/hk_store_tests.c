...
TEST_CASE("Check writing/reading string as blob.", "[store]")
{
...
TEST_CASE("Check writing/reading byte array.", "[store]")
{
    TEST_ASSERT_FALSE(hk_store_init());
    char buffer[] = {
        0xde, 0xf0, 0x5c, 0xe5, 0x1d, 0x01, 0xe6, 0xcc, 0x3d, 0x6b, 0x34, 0xf7, 0xd8, 0xd5, 0x87, 0x08,
        0x01, 0x68, 0xad, 0x61, 0x35, 0xd4, 0x9c, 0x9f, 0x65, 0xa3, 0x25, 0x7d, 0x00, 0x00, 0x04, 0xb4};
...
TEST_CASE("Check writing/reading bool.", "[store]")
{
    TEST_ASSERT_FALSE(hk_store_init());
