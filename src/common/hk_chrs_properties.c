...
hk_format_t hk_chrs_properties_get_type(hk_chr_types_t chr_type)
{
    ...
    case HK_CHR_CURRENT_HUMIDIFIER_DEHUMIDIFIER_STATE:
    case HK_CHR_IN_USE:
    case HK_CHR_IS_CONFIGURED:
    case HK_CHR_PROGRAM_MODE:
    case HK_CHR_TARGET_HUMIDIFIER_DEHUMIDIFIER_STATE:
    case HK_CHR_VALVE_TYPE:
        return HK_FORMAT_UINT8;
    case HK_CHR_ACCESSORY_FLAGS:
    case HK_CHR_COLOR_TEMPERATURE:
    case HK_CHR_ACTIVE_IDENTIFIER:
    case HK_CHR_REMAINING_DURATION:
    case HK_CHR_SET_DURATION:
    ...
    case HK_CHR_RELATIVE_HUMIDITY_DEHUMIDIFIER_THRESHOLD:
    case HK_CHR_RELATIVE_HUMIDITY_HUMIDIFIER_THRESHOLD:
    case HK_CHR_WATER_LEVEL:
...
uint16_t hk_chrs_properties_get_prop(hk_chr_types_t chr_type)
{
    ...
    // properties only supporting paired reads
    case HK_CHR_FIRMWARE_REVISION:
    case HK_CHR_HARDWARE_REVISION:
    case HK_CHR_MANUFACTURER:
    case HK_CHR_MODEL:
    ...
    // properties only supporting paired writes
    case HK_CHR_HOLD_POSITION:
    case HK_CHR_IDENTIFY:
    case HK_CHR_LOCK_CONTROL_POINT:
    case HK_CHR_RESET_FILTER_INDICATION:
    ...
    // characteristics supporting paired reads and can notify
    case HK_CHR_ACCESSORY_FLAGS:
    case HK_CHR_AIR_PARTICULATE_DENSITY:
    case HK_CHR_AIR_PARTICULATE_SIZE:
    case HK_CHR_AIR_QUALITY:
    ...
    // characteristics supporting paired reads, writes and notifications
    case HK_CHR_ACTIVE:
    case HK_CHR_ADMINISTRATOR_ONLY_ACCESS:
    case HK_CHR_AUDIO_FEEDBACK:
    case HK_CHR_BRIGHTNESS:
